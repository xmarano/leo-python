/* CodeMirror - Minified & Bundled
   Generated on 3/14/2016 with http://codemirror.net/doc/compress.html
   Version: HEAD
...
! function(a) {
    ...
    function K(a) {
        var b = ig(a.gutters, "CodeMirror-linenumbers"); - 1 == b && a.lineNumbers ? a.gutters = a.gutters.concat(["CodeMirror-linenumbers"]) : b > -1 && !a.lineNumbers && (a.gutters = a.gutters.slice(0), a.gutters.splice(b, 1))
    }
    ...
    function Z(a, b) {
        for (var c = b.viewport, d = !0;
            (d && a.options.lineWrapping && b.oldDisplayWidth != tb(a) || (c && null != c.top && (c = {
    ...
    function _(a, b) {
        a.display.sizer.style.minHeight = b.docHeight + "px", a.display.heightForcer.style.top = b.docHeight + "px", a.display.gutters.style.height = Math.max(b.docHeight + a.display.barHeight + sb(a), b.clientHeight) + "px"
    }
    ...
    function aa(a) {
        for (var b = a.display, c = b.lineDiv.offsetTop, d = 0; d < b.view.length; d++) {
            ...
            if (!e.hidden) {
                ...
                if (2 > h && (h = Ub(b)), (k > .001 || -.001 > k) && (mf(e.line, h), ba(e.line), e.rest))
    ...
    function ec(a) {
        ...
        if (f)
            for (var h = 0; h < f.length; ++h) f[h].lines.length || Qf(f[h], "hide");
        if (g)
            for (var h = 0; h < g.length; ++h) g[h].lines.length && Qf(g[h], "unhide");
    ...
    function lc(a, b, c, d) {
        ...
        var e = a.display;
        if (d && c < e.viewTo && (null == e.updateLineNumbers || e.updateLineNumbers > b) && (e.updateLineNumbers = b), a.curOp.viewChanged = !0, b >= e.viewTo) w && xe(a.doc, b) < e.viewTo && nc(a);
        else if (c <= e.viewFrom) w && ye(a.doc, c + d) > e.viewFrom ? nc(a) : (e.viewFrom += d, e.viewTo += d);
        else if (b <= e.viewFrom && c >= e.viewTo) nc(a);
    ...
    function mc(a, b, c) {
        ...
        if (e && b >= e.lineN && b < e.lineN + e.size && (d.externalMeasured = null), !(b < d.viewFrom || b >= d.viewTo)) {
            var f = d.view[oc(a, b)];
            if (null != f.node) {
                var g = f.changes || (f.changes = []); - 1 == ig(g, c) && g.push(c)
            }
        }
    }
    ...
    function Cc(a, b, c, d, e) {
            ...
            if (0 != ra(n, b))
                if (n = b, "rect" == d) {
                    ...
                    if ("single" != d) {
                        ...
                        else var w = new La(qa(b.line, 0), Pa(g, qa(b.line + 1, 0)));
        ...
        var h, i, j = g.sel,
            k = j.ranges;
        if (e && !b.shiftKey ? (i = g.sel.contains(c), h = i > -1 ? k[i] : new La(c, c)) : (h = g.sel.primary(), i = g.sel.primIndex), b.altKey) d = "rect", e || (h = new La(c, c)), c = wc(a, b, !0, !0), i = -1;
        else if ("double" == d) {
                ...
                if (d && d.length && window.FileReader && window.File)
                    ...
                    try {
                        ...
                        if (g) {
                            ...
                            if (_a(b.doc, Na(c, c)), k)
                                for (var j = 0; j < k.length; ++j) qd(b.doc, "", k[j].anchor, k[j].head, "drag");
    ...
    function Kc(a, b) {
        Math.abs(a.doc.scrollTop - b) < 2 || (a.doc.scrollTop = b, c || $(a, {
            top: b
        }), a.display.scroller.scrollTop != b && (a.display.scroller.scrollTop = b), a.display.scrollbars.setScrollTop(b), c && $(a), lb(a, 100))
    }
    ...
    function kd(a, b, c) {
        ...
        if (!(Wf(a, "beforeChange") || a.cm && Wf(a.cm, "beforeChange")) || (b = jd(a, b, !0))) {
            ...
            if (d)
                for (var e = d.length - 1; e >= 0; --e) ld(a, {
                    from: d[e].from,
                    to: d[e].to,
                    text: e ? [""] : b.text
                });
        ...
        if (!a.cm || !a.cm.state.suppressEdits) {
            ...
            if (i != g.length) {
                for (d.lastOrigin = d.lastSelOrigin = null; e = g.pop(), e.ranges;) {
                    if (yf(e, h), c && !e.equals(a.sel)) return void $a(a, e, {
                        clearRedo: !1
                    });
                    f = e
                }
                ...
                for (var k = Wf(a, "beforeChange") || a.cm && Wf(a.cm, "beforeChange"), i = e.changes.length - 1; i >= 0; --i) {
                    ...
                    j.push(sf(a, l));
                    var m = i ? gd(a, l) : gg(g);
                    od(a, l, m, ke(a, l)), !i && a.cm && a.cm.scrollIntoView({
                        from: l.from,
                        to: ed(l)
                    });
                    var n = [];
    ...
    function qd(a, b, c, d, e) {
        ...
        "string" == typeof b && (b = a.splitLines(b)), kd(a, {
            from: c,
            to: d,
            text: b,
            origin: e
    ...
    function Yd(a, b, c, d, e) {
        ...
        if (a.iter(h, c.line + 1, function(a) {
            ...
            if (j && (i.curOp.updateMaxLine = !0), f.collapsed) lc(i, b.line, c.line + 1);
            else if (f.className || f.title || f.startStyle || f.endStyle || f.css)
                for (var k = b.line; k <= c.line; k++) mc(i, k, "text");
    ...
    function be(a) {
        for (var b = 0; b < a.length; b++) {
            ...
            for (var e = 0; e < c.markers.length; e++) {
                var f = c.markers[e]; - 1 == ig(d, f.doc) && (f.parent = null, c.markers.splice(e--, 1))
            }
        }
    }
    ...
    function ie(a, b) {
        ...
        if (!j) {
            ...
            if (p > 0 && h)
                for (var l = 0; l < h.length; ++l) null == h[l].to && (q || (q = [])).push(new ce(h[l].marker, null, null));
    ...
    function re(a, b) {
        ...
        if (c)
            for (var e, f = 0; f < c.length; ++f) e = c[f], e.marker.collapsed && null == (b ? e.from : e.to) && (!d || qe(d, e.marker) < 0) && (d = e.marker);
        return d
    }
    ...
    function Ae(a, b, c) {
        ...
        for (var e, f = 0; f < b.markedSpans.length; ++f)
            if (e = b.markedSpans[f], e.marker.collapsed && !e.marker.widgetNode && e.from == c.to && (null == e.to || e.to != c.from) && (e.marker.inclusiveLeft || c.marker.inclusiveRight) && Ae(a, b, e)) return !0
    }
    ...
    function Le(a, b, c, d) {
        ...
        var l, i = jf(f, b.line),
            j = ob(a, b.line, c),
            k = new Vd(i.text, a.options.tabSize);
        for (d && (l = []);
            (d || k.pos < b.ch) && !k.eol();) k.start = k.pos, h = Ke(g, k, j), d && l.push(e(!0));
        return d ? l : e()
    }
        ...
        if (d)
            for (var k, l, n, o, p, q, r, h = e.length, i = 0, g = 1, j = "", m = 0;;) {
                if (m == i) {
                    ...
                    if (!r || r.from == i)
                        for (var u = 0; u < s.length; ++u) Ye(b, 0, s[u]);
                    if (r && (r.from || 0) == i) {
                ...
                for (var g = 1; g < c.length; g += 2) b.addToken(b, e.slice(f, f = c[g]), Se(c[g + 1], b.cm.options))
    }
    ...
    function nf(a) {
        ...
        for (var b = a.parent, c = ig(b.lines, a), d = b.parent; d; b = d, d = d.parent)
            ...
            if (f.ranges) e.push(c ? Ka.prototype.deepCopy.call(f) : f);
                ...
                for (var i = 0; i < g.length; ++i) {
                    ...
                    if (h.push({
                        ...
                        for (var l in j)(k = l.match(/^spans_(\d+)$/)) && ig(b, Number(k[1])) > -1 && (gg(h)[l] = j[l], delete j[l])
                }
            }
        }
        return e
    ...
    function Vf(a) {
        ...
        if (b)
            for (var c = a.curOp.cursorActivityHandlers || (a.curOp.cursorActivityHandlers = []), d = 0; d < b.length; ++d) - 1 == ig(c, b[d]) && c.push(b[d])
    }
    ...
    function eh(a, b, c, d) {
        var e = b + c;
        if (d)
            for (; e > 0 && tg(a.text.charAt(e));) e += c;
    ...
    Ca.prototype = mg({
        ...
        init: function(a) {
            function e(a) {
                if (!Uf(c, a)) {
                    if (c.somethingSelected()) wa = c.getSelections(), "cut" == a.type && c.replaceSelection("", null, "cut");
                    else {
                        if (!c.options.lineWiseCopyCut) return;
                        var b = Aa(c);
    ...
    x.prototype = {
        ...
        indentSelection: hc(function(a) {
            for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
                var e = b[d];
                if (e.empty()) e.head.line > c && (yd(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && wd(this));
                else {
                    var f = e.from(),
                        g = e.to(),
                        h = Math.max(c, f.line);
        ...
        getTokenTypeAt: function(a) {
            a = Pa(this.doc, a);
            var f, b = Oe(this, jf(this.doc, a.line)),
                c = 0,
                d = (b.length - 1) / 2,
                e = a.ch;
            if (0 == e) f = b[2];
        ...
        lineAtHeight: function(a, b) {
            return a = Mb(this, {
                top: a,
                left: 0
            }, b || "page").top, of (this.doc, a + this.display.viewOffset)
        },
        ...
        scrollIntoView: hc(function(a, b) {
            if (null == a ? (a = {
                    ...
                    from: a,
                    to: null
                }), a.to || (a.to = a.from), a.margin = b || 0, null != a.from.line) xd(this), this.curOp.scrollToPos = a;
            else {
    ...
    x.defineMode = function(a, b) {
        ...
        if ("string" == typeof a && Id.hasOwnProperty(a)) a = Id[a];
        else if (a && "string" == typeof a.name && Id.hasOwnProperty(a.name)) {
            var b = Id[a.name];
            "string" == typeof b && (b = {
                name: b
            }), a = lg(b, a), a.name = b.name
    ...
    x.registerHelper = function(a, b, c) {
        ...
        x.registerHelper(a, b, d), Ld[a]._global.push({
            pred: c,
            val: d
        })
    };
...
function(a) {
    ...
    a.registerHelper("hintWords", "python", d.concat(e)), a.defineMode("python", function(i, j) {
        function x(a, b) {
            if (a.sol() && (b.indent = a.indentation()), a.sol() && "py" == h(b).type) {
                var c = h(b).offset;
                if (a.eatSpace()) {
                    var d = a.indentation();
                    return d > c ? A(b) : c > d && C(a, b) && (b.errorToken = !0), null
                }
                var e = y(a, b);
                return c > 0 && C(a, b) && (e += " " + k), e
            }
            return y(a, b)
        }
        ...
        function z(a) {
            ...
            for (;
                "rub".indexOf(a.charAt(0).toLowerCase()) >= 0;) a = a.substr(1);
            var b = 1 == a.length,
                c = "string";
        ...
        function A(a) {
            for (;
                "py" != h(a).type;) a.scopes.pop();
            a.scopes.push({
                offset: h(a).offset + i.indentUnit,
                type: "py",
                align: null
            })
        }
        ...
        function B(a, b, c) {
            var d = a.match(/^([\s\[\{\(]|#.*)*$/, !1) ? null : a.column() + 1;
            b.scopes.push({
                offset: b.indent + r,
                type: c,
                align: d
        ...
        function C(a, b) {
            for (var c = a.indentation(); h(b).offset > c;) {
                if ("py" != h(b).type) return !0;
                b.scopes.pop()
            }
            return h(b).offset != c
        }
        ...
        function D(a, b) {
            ...
            "variable" != c && "builtin" != c || "meta" != b.lastToken || (c = "meta"), ("pass" == d || "return" == d) && (b.dedent += 1), "lambda" == d && (b.lambda = !0), ":" != d || b.lambda || "py" != h(b).type || A(b);
            var e = 1 == d.length ? "[({".indexOf(d) : -1;
            if (-1 != e && B(a, b, "])}".slice(e, e + 1)), e = "])}".indexOf(d), -1 != e) {
                if (h(b).type != d) return k;
                b.indent = b.scopes.pop().offset - r
            }
            return b.dedent > 0 && a.eol() && "py" == h(b).type && (b.scopes.length > 1 && b.scopes.pop(), b.dedent -= 1), c
        }
        var k = "error",
            l = j.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.]/,
            m = j.doubleOperators || /^([!<>]==|<>|<<|>>|\/\/|\*\*)/,
            n = j.doubleDelimiters || /^(\+=|\-=|\*=|%=|\/=|&=|\|=|\^=)/,
            o = j.tripleDelimiters || /^(\/\/=|>>=|<<=|\*\*=)/;
        if (j.version && 3 == parseInt(j.version, 10)) var p = j.singleOperators || /^[\+\-\*\/%&|\^~<>!@]/,
            q = j.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
        else var p = j.singleOperators || /^[\+\-\*\/%&|\^~<>!]/,
            q = j.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
        ...
        var v = b(s),
            ...
            E = {
                ...
                token: function(a, b) {
                    ...
                    c && (b.errorToken = !1);
                    var d = D(a, b);
                    return d && "comment" != d && (b.lastToken = "keyword" == d || "punctuation" == d ? a.current() : d), "punctuation" == d && (d = null), a.eol() && b.lambda && (b.lambda = !1), c ? d + " " + k : d
                },
                indent: function(b, c) {
                    if (b.tokenize != x) return b.tokenize.isString ? a.Pass : 0;
                    var d = h(b),
                        e = d.type == c.charAt(0);
                    return null != d.align ? d.align - (e ? 1 : 0) : d.offset - (e ? r : 0)
                },
                electricInput: /^\s*[\}\]\)]$/,
                closeBrackets: {
                    triples: "'\""
...
function(a) {
    ...
    function j(b, c) {
        return b.isReadOnly() ? a.Pass : void b.operation(function() {
            for (var a = b.listSelections().length, e = [], f = -1, g = 0; a > g; g++) {
                var h = b.listSelections()[g].head;
                if (!(h.line <= f)) {
                    var i = d(h.line + (c ? 0 : 1), 0);
                    b.replaceRange("\n", i, null, "+insertLine"), b.indentLine(i.line, null, !0), e.push({
                        head: i,
                        anchor: i
                    }), f = h.line + 1
                }
    ...
    function m(a) {
        ...
        if (c)
            for (;;) {
                ...
                if (!e) return;
                if (e.ch == l.charAt(l.indexOf(c.ch) + 1)) return a.setSelection(d(c.pos.line, c.pos.ch + 1), e.pos, !1), !0;
                b = d(e.pos.line, e.pos.ch + 1)
            }
    }

    function o(b, c) {
        if (b.isReadOnly()) return a.Pass;
        for (var g, e = b.listSelections(), f = [], h = 0; h < e.length; h++) {
            var i = e[h];
            if (!i.empty()) {
                for (var j = i.from().line, k = i.to().line; h < e.length - 1 && e[h + 1].from().line == k;) k = i[++h].to().line;
                f.push(j, k)
            }
        }
        f.length ? g = !0 : f.push(b.firstLine(), b.lastLine()), b.operation(function() {
            for (var a = [], e = 0; e < f.length; e += 2) {
                var h = f[e],
                    ...
                    k = d(i),
                    l = b.getRange(j, k, !1);
                c ? l.sort() : l.sort(function(a, b) {
                    var c = a.toUpperCase(),
                        d = b.toUpperCase();
                    return c != d && (a = c, b = d), b > a ? -1 : a == b ? 0 : 1
                }), b.replaceRange(l, j, k), g && a.push({
                    anchor: j,
                    head: k
                })
            }
        ...
        b.operation(function() {
            ...
            for (var i, g = e.length - 1; g >= 0; g--) {
                ...
                if (!(i && a.cmpPos(h.head, i) > 0)) {
                    var j = k(b, h.head);
                    i = j.from, b.replaceRange(c(j.word), j.from, j.to)
                }
            }
        })
    }
    ...
    var i = e ? "Ctrl-Alt-" : "Ctrl-";
    c[b[i + "Up"] = "scrollLineUp"] = function(a) {
        ...
        if (0 == a.cmpPos(c, e)) {
            ...
            var h = b.getRange(c, e),
                ...
                j = b.getSearchCursor(i, e);
            j.findNext() ? b.addSelection(j.from(), j.to()) : (j = b.getSearchCursor(i, d(b.firstLine(), 0)), j.findNext() && b.addSelection(j.from(), j.to()))
        }
        f && (b.state.sublimeFindFullWord = b.doc.sel)
    };
    var l = "(){}[]";
    ...
    var n = e ? "Cmd-Ctrl-" : "Shift-Ctrl-";
    c[b[n + "Up"] = "swapLineUp"] = function(b) {
        if (b.isReadOnly()) return a.Pass;
        for (var c = b.listSelections(), e = [], f = b.firstLine() - 1, g = [], h = 0; h < c.length; h++) {
            var i = c[h],
                j = i.from().line - 1,
                k = i.to().line;
            g.push({
                anchor: d(i.anchor.line - 1, i.anchor.ch),
                head: d(i.head.line - 1, i.head.ch)
            }), 0 != i.to().ch || i.empty() || --k, j > f ? e.push(j, k) : e.length && (e[e.length - 1] = k), f = k
        }
        b.operation(function() {
            for (var a = 0; a < e.length; a += 2) {
                var c = e[a],
                    f = e[a + 1],
                    h = b.getLine(c);
                b.replaceRange("", d(c, 0), d(c + 1, 0), "+swapLine"), f > b.lastLine() ? b.replaceRange("\n" + h, d(b.lastLine()), null, "+swapLine") : b.replaceRange(h + "\n", d(f, 0), null, "+swapLine")
            }
            b.setSelections(g), b.scrollIntoView()
        })
    }, c[b[n + "Down"] = "swapLineDown"] = function(b) {
        if (b.isReadOnly()) return a.Pass;
        for (var c = b.listSelections(), e = [], f = b.lastLine() + 1, g = c.length - 1; g >= 0; g--) {
            var h = c[g],
                i = h.to().line + 1,
                j = h.from().line;
            0 != h.to().ch || h.empty() || i--, f > i ? e.push(i, j) : e.length && (e[e.length - 1] = j), f = j
        }
        b.operation(function() {
            for (var a = e.length - 2; a >= 0; a -= 2) {
                var c = e[a],
                    f = e[a + 1],
                    g = b.getLine(c);
                c == b.lastLine() ? b.replaceRange("", d(c - 1), d(c), "+swapLine") : b.replaceRange("", d(c, 0), d(c + 1, 0), "+swapLine"), b.replaceRange(g + "\n", d(f, 0), null, "+swapLine")
            }
            b.scrollIntoView()
        })
    ...
    var p = f + "K ";
    b[p + f + "Backspace"] = "delLineLeft", c[b.Backspace = "smartBackspace"] = function(b) {
        ...
        var c = b.getCursor(),
            ...
            f = a.countColumn(e, null, b.getOption("tabSize")),
            g = b.getOption("indentUnit");
        if (e && !/\S/.test(e) && f % g == 0) {
            var h = new d(c.line, a.findColumn(e, f - g, g));
            return h.ch == c.ch ? a.Pass : b.replaceRange("", h, c, "+delete")
        }
        return a.Pass
